...
annotate CAPBuilderService.Service with @UI: {
...
annotate CAPBuilderService.Association with @UI: {
...
annotate CAPBuilderService.Entity with @UI: {
...
annotate CAPBuilderService.Action with @UI: {

  Identification          : [{
    $Type : 'UI.DataFieldForAction',
    Action: 'CAPBuilderService.ActionPrefillLabel',
...
annotate CAPBuilderService.Facet with @UI: {
  ...
  LineItem           : [
    {
      $Type : 'UI.DataFieldForAction',
      Action: 'CAPBuilderService.FacetPrefillLabel',
      Label : '{i18n>Action-ActionPrefillLabel}'
    },
...
annotate CAPBuilderService.Field with @UI: {

  Identification              : [{
    $Type : 'UI.DataFieldForAction',
    Action: 'CAPBuilderService.prefillLabel',
...
annotate CAPBuilderService.ValueHelp with @UI: {
  ...
  LineItem           : [
    {
      $Type : 'UI.DataFieldForAction',
      Action: 'CAPBuilderService.ValueHelpPrefillLabel',
      Label : '{i18n>Action-ActionPrefillLabel}'
    },
...
annotate CAPBuilderService.ActionParameter with @UI: {
  ...
  LineItem           : [
    {
      $Type : 'UI.DataFieldForAction',
      Action: 'CAPBuilderService.ActionParamPrefillLabel',
      Label : '{i18n>Action-ActionPrefillLabel}'
    },
...
annotate CAPBuilderService.ServiceRole with @UI: {

  Identification        : [{
    $Type : 'UI.DataFieldForAction',
    Action: 'CAPBuilderService.fillEntities',
...
annotate CAPBuilderService.ServiceAuth with @UI: {
