...
annotate CAPBuilderService.Association {
...
annotate CAPBuilderService.Association with {
...
annotate CAPBuilderService.Field {
    FieldType @(Common: {
...
annotate CAPBuilderService.Entity {
...
annotate CAPBuilderService.ValueHelp with {
...
annotate CAPBuilderService.ValueHelp {
    InputType @(Common: {
...
annotate CAPBuilderService.ActionParameter {
...
annotate CAPBuilderService.ServiceAuth {
    AuthType @(Common: {
...
annotate CAPBuilderService.ServiceAuth with {
    AuthEntity @(Common: {
